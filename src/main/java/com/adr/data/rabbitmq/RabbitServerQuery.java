...
public class RabbitServerQuery {
    ...
    private static final Logger LOG = Logger.getLogger(RabbitServerQuery.class.getName());
    ...
    public RabbitServerQuery(Connection connection, String queryqueue, QueryLink link) {
