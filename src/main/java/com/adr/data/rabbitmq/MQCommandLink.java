 ...
 * @author adrian
 */
public class MQCommandLink implements CommandLink {
...
//        channel.close();
    ...
    public MQCommandLink(RpcClient client) {
        this.client = client;
    }
    ...
    public void execute(Header headers, List<Record> l) throws DataException {
        ...
        try {
            ...
            ResponseCommand envelope = ResponseCommand.read(new String(response, StandardCharsets.UTF_8));            
            envelope.getResult();
