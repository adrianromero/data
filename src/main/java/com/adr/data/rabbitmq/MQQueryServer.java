 ...
 * @author adrian
 */
public class MQQueryServer extends RpcServer {

    private static final Logger LOG = Logger.getLogger(MQQueryServer.class.getName());

    private final QueryLink link;

    public MQQueryServer(Channel channel, String queueName, QueryLink link) throws IOException {
