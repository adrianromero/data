 ...
 * @author adrian
 */
public class ResponseCommandError extends ResponseCommand {

    public static final String NAME = "ERROR";

    private final Throwable ex;

    public ResponseCommandError(Throwable ex) {
        this.ex = ex;
    }
    ...
    public static ResponseCommand readData(Loader loader) throws IOException {
        ...
        if (CodePoint.isEOF(loader.getCP())) {
            ...
            return new ResponseCommandError(ResponseErrors.createException(name, message));
        } else {
