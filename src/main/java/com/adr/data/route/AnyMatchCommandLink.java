 ...
 * @author adrian
 */
public class AnyMatchCommandLink implements CommandLink {
    
    private final CommandLink commandlink;
    private final Predicate<? super Record> p;
    private final boolean iffailex;

    public AnyMatchCommandLink(CommandLink commandlink,  Predicate<? super Record> p, boolean iffailex) {
        this.commandlink = commandlink;
        this.p = p;
        this.iffailex = iffailex;
    }

    public AnyMatchCommandLink(CommandLink commandlink,  Predicate<? super Record> p) {
        this.commandlink = commandlink;
        this.p = p;
        this.iffailex = false;
    }
